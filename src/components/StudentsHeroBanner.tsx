...
interface StudentsHeroBannerProps {
  ...
  /**
   * Hint opcional da personagem do hero (professora/professor/neutra). O cadastro
   * do usuário AINDA NÃO tem esse campo hoje — nenhum chamador precisa passar
   * isto. Quando ausente, a personagem neutra é exibida (fallback seguro).
   * Tipado como string para não acoplar a `types.ts`/migration.
   */
